		...
		<div class="clear"> </div>
		   ...
		   <div class="footer">
		   	<div class="wrap">
				<div class="row">
					<div class="col-md-5">
						<p style="margin-top:10px">&copy; 2017. All rights reserved.</p>
					</div>
					<div class="col-span-offset-3 col-md-4">
						<span class="inventivekeys">Designed & Developed By <a href="http://www.inventivekeys.com" target="_blank"><h2 >INVENTIVE<span style="color:#ee332f;">KEYS</span></h2></a></span>
					</div>
					<div class="clear"> </div>
			   </div>
			</div>
