<?php include('header.php')?>
		<section class="faq-title text-center">
			<div class="faq-wrapper">
				<div class="container">
					<div class= "row">
						<h1 class="headline1">Frequently Asked Questions</h1>
					</div>
					<div class="row">
		...
		<section class="faq-content">
			<div class="container">
				<div class="row">
					<main class="col-md-9">
						<div class="faq-header ">Things you need to know...</div>

							<div class="faq-c ">
							  <div class="faq-q accordion-header"><span class="faq-t">+</span>Could my cell phone kill me?</div>
							  <div class="faq-a accordion-content">
							...
							<div class="faq-c">
							  <div class="faq-q accordion-header"><span class="faq-t">+</span>Should I really be taking four times the recommended daily dose? </div>
							  <div class="faq-a accordion-content">
							...
							<div class="faq-c">
							  <div class="faq-q accordion-header"><span class="faq-t">+</span>What happens if Pinocchio says, "my nose will grow now"</div>
							  <div class="faq-a accordion-content">
						...
						<div class="widget widget_iw_last_posts" id="iw_last_posts-3">
							...
							<div class="row">
								<div class="col-md-4 col-xs-3">
									<a href="#">
										<img width="150" height="150" src="assets/img/donation1.jpg" class="img-responsive h5 wp-post-image" alt="Medical Theme Health and Care">
									</a>
								</div>
							...
							<div class="row">
								<div class="col-md-4 col-xs-3">
									<a href="#">
										<img width="150" height="150" src="assets/img/img_thumb_1.jpg" class="img-responsive h5 wp-post-image" alt="Medical Theme Health and Care">
									</a>
								</div>
							...
							<div class="row">
								<div class="col-md-4 col-xs-3">
									<a href="#">
										<img width="150" height="150" src="assets/img/rehabilitation1.jpg" class="img-responsive h5 wp-post-image" alt="Medical Theme Health and Care">
									</a>
								</div>
							...
							<div class="row">
								<div class="col-md-4 col-xs-3">
									<a href="#">
										<img width="150" height="150" src="assets/img/shutterstock_85440868-150x150.jpg" class="img-responsive h5 wp-post-image" alt="Medical Theme Health and Care">
									</a>
								</div>
							...
							<div class="row">
								<div class="col-md-4 col-xs-3">
									<a href="#">
										<img width="150" height="150" src="assets/img/staff2 (2).jpg" class="img-responsive h5 wp-post-image" alt="Medical Theme Health and Care">
									</a>
								</div>
