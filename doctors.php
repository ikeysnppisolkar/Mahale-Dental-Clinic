...
include("hms/include/config.php");
 ...
 if(isset($_POST['submit']))
 {
   ...
   if(empty($cv))
			{
				$ercv="Please Upload Your CV";
				
			}

	else if($FileType != "doc" && $FileType != "pdf" && $FileType != "docx") 
			{
			  $ercv= "Sorry, only pdf or doc files are allowed.";
	...
	else
	{
		...
		$query="INSERT INTO career(name,email,cv) VALUES ('$name','$email','$target')";
	        			...
	        			<div class="col-lg-6 col-md-6 col-sm-6">
							...
							<div >
								<div class="input-group margin-bottom-sm">
								 	...
								 	<input class="form-control" type="text" placeholder="Name" name="name" id="fname">
								...
								<div class="input-group margin-bottom-sm">
								 	...
								 	<input class="form-control" type="text" placeholder="Email address" name="email" id="emailadd">
								...
								<div class="input-group margin-bottom-sm">
								 	...
								 	<input type="file" class="btn btn-info form-control" name="cv" id="fileToUpload" >
